/* prebid.js v8.23.0
Updated: 2024-08-14
Modules: userId, jixieBidAdapter, yandexBidAdapter, express, schain, gptPreAuction, unifiedIdSystem, uid2IdSystem, currency */
...
(self.jxpbjsChunk=self.jxpbjsChunk||[]).push([[238],{1374:(e,t,n)=>{var r=n(8640),i=n(4358),s=n(265),a=n(6475),o=n(5339),d=n(4679),c=n(59),u=n(3193);const p="EUR",l=[d.Mk,d.B5],f={title:[1,0],body:[2,2],body2:[3,10],sponsoredBy:[4,1],icon:[5,1],image:[6,3],displayUrl:[7,11],cta:[8,12],rating:[9,3],likes:[10,4]},m={};(0,i.yi)(f,((e,t)=>{m[e[0]]=t}));const h={code:"yandex",aliases:["ya"],supportedMediaTypes:l,isBidRequestValid:function(e){const{params:t}=e;if(!t)return!1;const{pageId:n,impId:r}=y(t);return!(!n||!r)},buildRequests:function(e,t){e=(0,c.lY)(e);let n="",r="",o="";t&&t.refererInfo&&(n=t.refererInfo.ref,r=t.refererInfo.domain,o=t.refererInfo.page);let d=null;t&&(d=t.timeout);const f=u.vc.getConfig("currency.adServerCurrency");return e.map((e=>{const{params:c}=e,{targetRef:u,withCredentials:m=!0,cur:h}=c,{pageId:b,impId:w}=y(c),v={"imp-id":w,"target-ref":u||r,"ssp-id":10500};if(Boolean((0,s.Z)(t,"gdprConsent.gdprApplies"))){const e=(0,s.Z)(t,"gdprConsent.consentString");v.gdpr=1,v["tcf-consent"]=e}const C={id:w,banner:g(e),native:I(e)},x=function(e){const t=[];"function"==typeof e.getFloor&&l.forEach((n=>{if(e.hasOwnProperty(n)){const r=e.getFloor({currency:p,mediaType:n,size:e.sizes||"*"});t.push(r)}}));return t.sort(((e,t)=>t.floor-e.floor))[0]}(e);x&&(C.bidfloor=x.floor,C.bidfloorcur=x.currency);const O=h||f;O&&(v["ssp-cur"]=O);const R={id:e.bidId,imp:[C],site:{ref:n,page:o,domain:r},tmax:d},T=(0,s.Z)(e,"userIdAsEids");T&&T.length&&(0,a.N)(R,"user.ext.eids",T);return{method:"POST",url:`https://bs.yandex.ru/prebid/${b}?${(0,i.Yp)(v)}`,data:R,options:{withCredentials:m},bidRequest:e}}))},interpretResponse:function(e,t){let{bidRequest:n}=t;if(!e.body.seatbid)return[];const{seatbid:r,cur:s}=e.body,a=r.map((e=>e.bid)).reduce(((e,t)=>e.concat(t)),[]),o=s||p;return a.map((e=>{const t=e.price;let r={requestId:n.bidId,cpm:t,currency:o,width:e.w,height:e.h,creativeId:e.adid,nurl:b(e.nurl,t,o),netRevenue:!0,ttl:180,meta:{advertiserDomains:e.adomain&&e.adomain.length>0?e.adomain:[]}};return 0===e.adm.indexOf("{")?(r.mediaType=d.B5,r.native=function(e,t,n){try{const{adm:r}=e,{native:s}=JSON.parse(r),a={clickUrl:s.link.url};return s.assets.forEach((e=>{const t=m[e.id];t&&(a[t]="image"===t||"icon"===t?{url:e.img.url,width:e.img.w,height:e.img.h}:"title"===t?e.title.text:e.data.value)})),a.impressionTrackers=(0,i.HA)(s.imptrackers,(e=>b(e,t,n))),a}catch(e){}}(e,t,o)):(r.mediaType=d.Mk,r.ad=e.adm),r}))},onBidWon:function(e){const t=e.nurl;t&&(0,i.hq)(t)}};function y(e){const{placementId:t}=e,n={pageId:null,impId:null};let r,i;if(t){const e=t.lastIndexOf("-");if(-1===e)return n;const s=t.lastIndexOf("-",e-1);r=t.slice(s+1,e),i=t.slice(e+1)}else r=e.pageId,i=e.impId;return parseInt(r,10)&&parseInt(i,10)?(n.pageId=r,n.impId=i,n):n}function g(e){if((0,s.Z)(e,"mediaTypes.banner")){const t=(e.sizes||e.mediaTypes.banner.sizes).map((e=>({w:e[0],h:e[1]}))),{w:n,h:r}=t[0];return{format:t,w:n,h:r}}}function I(e){const t=(0,s.Z)(e,"mediaTypes.native");if(t){const e=[];return Object.keys(t).forEach((n=>{if(f.hasOwnProperty(n)){const r=f[n],i=function(e,t,n){const[r,i]=n,s={id:r};t.required&&(s.required=1);"title"===e?s.title={len:t.len||25}:"image"===e||"icon"===e?s.img=function(e,t){const n={type:t};if(e.aspect_ratios){const t=e.aspect_ratios[0],r=t.min_width||100;n.wmin=r,n.hmin=r/t.ratio_width*t.ratio_height}if(e.sizes){const t=Array.isArray(e.sizes[0])?e.sizes[0]:e.sizes;n.w=t[0],n.h=t[1]}return n}(t,i):s.data={type:i,len:t.len};return s}(n,t[n],r);e.push(i)}})),{ver:1.1,request:JSON.stringify({ver:1.1,assets:e})}}}function b(e,t,n){if(e)return e.replace(/\${AUCTION_PRICE}/,t).replace(/\${AUCTION_CURRENCY}/,n)}(0,o.dX)(h),(0,r.z)("yandexBidAdapter")}},e=>{var t;t=1374,e(e.s=t)}]);
})(),jxpbjs.processQueue();window.jxpbjs=window.jxpbjs||{},jxpbjs.que=jxpbjs.que||[],jxpbjs.que.push(function(){window._jxbidsq=window._jxbidsq||[],jxpbjs.onEvent("auctionInit",function(e){_jxbidsq.push(["auctionInit",e])}),jxpbjs.onEvent("auctionEnd",function(e){_jxbidsq.push(["auctionEnd",e])}),jxpbjs.onEvent("bidWon",function(e){_jxbidsq.push(["bidWon",e])}),jxpbjs.onEvent("bidTimeout",function(e){_jxbidsq.push(["bidTimeout",e])}),jxpbjs.onEvent("bidRequested",function(e){_jxbidsq.push(["bidRequested",e])}),jxpbjs.onEvent("setTargeting",function(e){_jxbidsq.push(["setTargeting",e])}),jxpbjs.onEvent("bidResponse",function(e){_jxbidsq.push(["bidResponse",e])})}),window.googletag=window.googletag||{cmd:[]},googletag.cmd.push(function(){window._jxbidsq=window._jxbidsq||[],googletag.pubads().addEventListener("slotRenderEnded",function(e){_jxbidsq.push(["slotRenderEnded",e])}),googletag.pubads().addEventListener("impressionViewable",function(e){_jxbidsq.push(["impressionViewable",e])})}),window.jxHBLoadedCb&&window.jxHBLoadedCb();var jxloadJS=function(e,t,n){var i=document.createElement("script");i.src=e,t&&(i.onload=t,i.onreadystatechange=t),i.async=!0,n.appendChild(i)};!function(n,e,o){-1<window.location.search.indexOf("jxosovr=")&&(o.FAILSAFE_TIMEOUT=6e3,o.PREBID_TIMEOUT=5e3);var i=!0,e=(window.jxpbjs=window.jxpbjs||{},jxpbjs.que=jxpbjs.que||[],o.pbjs&&e(o.pbjs),window);const P=["hb_bidder","hb_adid","hb_pb","hb_size","hb_deal","hb_uuid","hb_cache_host","hb_cache_id","hb_adomain"];const r="nobid__";var d={};var s=function(){return o.FAILSAFE_TIMEOUT},a=function(){return!1},u={CREATED:0,PARTNERS_CALLED:1,TARGETING_ADDED:2,DISPLAYED:3};function t(e){this.name=e,this.status=u.CREATED,this.divID="",this.adUnitID="",this.adUnitIndex=0,this.sizes=[],this.keyValues={},this.arguments=[],this.pubAdServerObject=null,this.displayFunctionCalled=!1,this.refreshFunctionCalled=!1}t.prototype.getName=function(){return this.name},t.prototype.setStatus=function(e){return this.status=e,this},t.prototype.getStatus=function(){return this.status},t.prototype.setDivID=function(e){return this.divID=e,this},t.prototype.getDivID=function(){return this.divID},t.prototype.setAdUnitID=function(e){return this.adUnitID=e,this},t.prototype.getAdUnitID=function(){return this.adUnitID},t.prototype.setAdUnitIndex=function(e){return this.adUnitIndex=e,this},t.prototype.getAdUnitIndex=function(){return this.adUnitIndex},t.prototype.setSizes=function(e){return this.sizes=e,this},t.prototype.getSizes=function(){return this.sizes},t.prototype.setKeyValue=function(e,t){return this.keyValues[e]=t,this},t.prototype.setKeyValues=function(e){return this.keyValues=e,this},t.prototype.getkeyValues=function(){return this.keyValues},t.prototype.setArguments=function(e){return this.arguments=e,this},t.prototype.getArguments=function(){return this.arguments},t.prototype.setPubAdServerObject=function(e){return this.pubAdServerObject=e,this},t.prototype.getPubAdServerObject=function(){return this.pubAdServerObject},t.prototype.setDisplayFunctionCalled=function(e){return this.displayFunctionCalled=e,this},t.prototype.isDisplayFunctionCalled=function(){return this.displayFunctionCalled},t.prototype.setRefreshFunctionCalled=function(e){return this.refreshFunctionCalled=e,this},t.prototype.isRefreshFunctionCalled=function(){return this.refreshFunctionCalled},t.prototype.updateStatusAfterRendering=function(e){this.status=u.DISPLAYED,this.arguments=[],e?this.refreshFunctionCalled=!1:this.displayFunctionCalled=!1};var l={};function c(e,t){return!(!p(e)||!e.hasOwnProperty)&&e.hasOwnProperty(t)}l.createSlot=function(e){return new t(e)};var M="Function",B=Object.prototype.toString;function p(e){return"object"==typeof e&&null!==e}function g(e,t){return B.call(e)==="[object "+t+"]"}function f(e){return g(e,M)}function h(e){return g(e,"Array")}function b(e){console.log("JXDBG_"+e)}var y={addHookOnFunction:function(e,t,n,i){var o=e;p(e=t?e.__proto__:e)&&f(e[n])?(t=e[n],e[n]=i(o,t)):b("in assignNewDefination: oldReference is not a function")},isOwnProperty:c,isArray:h,isObject:p,isFunction:f,forEachOnArray:function(e,t){if(h(e)&&f(t))for(var n=0,i=e.length;n<i;n++)t(n,e[n])},forEachOnObject:function(e,t){if(p(e)&&f(t))for(var n in e)c(e,n)&&t(n,e[n])},logWarning:b,log:function(e){console.log("JXDBG_"+e)},logError:function(e){console.log("JXDBG_"+e)}},m={},S=m.displayHookIsAdded=!1,j={},x=(m.slotsMap=j,m);function v(e){return"object"==typeof e&&"function"==typeof e.getSlotId&&"function"==typeof e.getSlotId().getDomId&&(e=e.getSlotId().getDomId()),y.isOwnProperty(x.slotsMap,e)?x.slotsMap[e].getStatus():u.DISPLAYED}function D(n){var i=[];return y.forEachOnObject(x.slotsMap,function(e,t){y.isOwnProperty(n,t.getStatus())&&i.push(e)}),i}function A(e,t){var n=[],t=0==e.length||null==e[0]?t.getSlots():e[0];return y.forEachOnArray(t,function(e,t){t=x.generateSlotName(t);0<t.length&&(n=n.concat(t))}),n}function I(e,t){var n=0==t.length||null==t[0]?e.getSlots():t[0];let i="XXXXX_";for(var o=0;o<n.length;o++){var s=n[o];s&&s.getSlotElementId&&(i+=s.getSlotElementId()+" ")}return i}m.getAdUnitIndex=function(e){var t=0;try{var n=e.getSlotId().getId().split("_"),t=parseInt(n[n.length-1])}catch(e){}return t},m.getAdSlotSizesArray=function(e,t){var n=[];return y.isFunction(t.getSizes)&&y.forEachOnArray(t.getSizes(window.innerWidth,window.innerHeight),function(e,t){y.isFunction(t.getWidth)&&y.isFunction(t.getHeight)&&n.push([t.getWidth(),t.getHeight()])}),n},m.setDisplayFunctionCalledIfRequired=function(e,t){y.isObject(e)&&y.isFunction(e.getDivID)&&y.isArray(t)&&t[0]&&t[0]==e.getDivID()&&(e.setDisplayFunctionCalled(!0),e.setArguments(t))},m.storeInSlotsMap=function(e,n,t){var i;y.isOwnProperty(x.slotsMap,e)?t||x.slotsMap[e].setSizes(x.getAdSlotSizesArray(e,n)):((i=l.createSlot(e)).setDivID(e),i.setPubAdServerObject(n),i.setAdUnitID(n.getAdUnitPath()),i.setAdUnitIndex(x.getAdUnitIndex(n)),i.setSizes(x.getAdSlotSizesArray(e,n)),i.setStatus(u.CREATED),y.isObject(JSON)&&y.isFunction(JSON.stringify)&&y.forEachOnArray(n.getTargetingKeys(),function(e,t){i.setKeyValue(t,n.getTargeting(t))}),x.slotsMap[e]=i)},m.generateSlotName=function(e){if(y.isObject(e)&&y.isFunction(e.getSlotId)){e=e.getSlotId();if(e&&y.isFunction(e.getDomId))return e.getDomId()}return""},m.updateSlotsMapFromGoogleSlots=function(e,i,o){y.forEachOnArray(e,function(e,t){var n=x.generateSlotName(t);x.storeInSlotsMap(n,t,o),o&&y.isOwnProperty(x.slotsMap,n)&&x.setDisplayFunctionCalledIfRequired(x.slotsMap[n],i)})},m.getStatusOfSlotForDivId=v,m.updateStatusAfterRendering=function(e,t){y.isOwnProperty(x.slotsMap,e)&&x.slotsMap[e].updateStatusAfterRendering(t)},m.getSlotNamesByStatus=D,m.removeDMTargetingFromSlot=function(e){var n,i={};y.isOwnProperty(x.slotsMap,e)&&(n=x.slotsMap[e].getPubAdServerObject(),y.forEachOnArray(n.getTargetingKeys(),function(e,t){i[t]=n.getTargeting(t)}),n.clearTargeting(),y.forEachOnObject(i,function(e,t){y.isOwnProperty(x.wrapperTargetingKeys,e)||n.setTargeting(e,t)}))},m.updateStatusOfQualifyingSlotsBeforeCallingAdapters=function(e,i,o){y.forEachOnArray(e,function(e,t){var n;y.isOwnProperty(x.slotsMap,t)&&((n=x.slotsMap[t]).setStatus(u.PARTNERS_CALLED),o)&&(x.removeDMTargetingFromSlot(t),n.setRefreshFunctionCalled(!0),n.setArguments(i))})},m.arrayOfSelectedSlots=function(e){var n=[];return y.forEachOnArray(e,function(e,t){n.push(x.slotsMap[t])}),n},m.findWinningBidAndApplyTargeting=function(e){var t=d[e];if(t){x.slotsMap[e].setStatus(u.TARGETING_ADDED);var n=j[e].getPubAdServerObject();if(n.getTargetingKeys().forEach(function(e){var t;e.startsWith("hb_")&&2==(t=(t=e).split("_")).length&&"hb"==t[0]&&-1<P.indexOf(t[1])&&n.clearTargeting(e)}),null!=(e=t)&&e!=r)for(var i in t)i.startsWith("hb_")&&n.setTargeting(i,t[i])}},m.newDisableInitialLoadFunction=function(e,t){return y.isObject(e)&&y.isFunction(t)?function(){return S=!0,t.apply(e,arguments)}:(y.logError("disableInitialLoad: originalFunction is not a function"),null)},m.newEnableSingleRequestFunction=function(e,t){return y.isObject(e)&&y.isFunction(t)?function(){return t.apply(e,arguments)}:(y.log("enableSingleRequest: originalFunction is not a function"),null)},m.newDestroySlotsFunction=function(t,n){return y.isObject(t)&&y.isFunction(n)?function(){var e=arguments[0]||window.googletag.pubads().getSlots();return y.forEachOnArray(e,function(e,t){delete j[x.generateSlotName(t)]}),n.apply(t,arguments)}:(y.log("destroySlots: originalFunction is not a function"),null)},m.updateStatusAndCallOriginalFunction_Display=function(e,t,n,i){x.updateStatusAfterRendering(i[0],!1),k("display",i),n.apply(t,i)},m.findWinningBidIfRequired_Display=function(e,t){(t=t.getStatus())!=u.DISPLAYED&&t!=u.TARGETING_ADDED&&x.findWinningBidAndApplyTargeting(e)},m.processDisplayCalledSlot=function(e,t,n){x.getStatusOfSlotForDivId(n[0])!=u.DISPLAYED?x.updateStatusAndCallOriginalFunction_Display("Calling original display function after timeout with arguments, ",e,t,n):k("display",n)},m.executeDisplay=function(n,i,o,s){var r=0,a=window.setInterval(function(){let e=i;var t;e=e||o[0],t=e,(d[t]||n<=r)&&(window.clearInterval(a),s()),r+=10},10)},m.displayFunctionStatusHandler=function(e,t,n,i){switch(e){case u.CREATED:case u.PARTNERS_CALLED:var o=i[0];x.executeDisplay(s(),o,Object.keys(x.slotsMap),function(){y.forEachOnObject(x.slotsMap,function(e,t){x.findWinningBidIfRequired_Display(e,t)}),x.processDisplayCalledSlot(t,n,i)});break;case u.TARGETING_ADDED:x.updateStatusAndCallOriginalFunction_Display("As DM processing is already done, Calling original display function with arguments",t,n,i);break;case u.DISPLAYED:x.updateStatusAndCallOriginalFunction_Display("As slot is already displayed, Calling original display function with arguments",t,n,i)}},m.forQualifyingSlotNamesCallAdapters=function(e,n,i){let o=!1;if(0<e.length){x.updateStatusOfQualifyingSlotsBeforeCallingAdapters(e,n,i);n=x.arrayOfSelectedSlots(e);if(n.length){let t=J(i?"refresh":"display");n.forEach(function(e){t.divs.push(e.divID)}),o=(s=t.divs,0<F.filter(e=>-1<s.indexOf(e)).length),W(t)}}var s;return o},m.newDisplayFunction=function(t,n){return y.isObject(t)&&y.isFunction(n)?a()?function(){return k("display",arguments),n.apply(t,arguments)}:function(){if(Q("display",arguments),S)return k("display",arguments),n.apply(t,arguments);x.updateSlotsMapFromGoogleSlots(t.pubads().getSlots(),arguments,!0),x.displayFunctionStatusHandler(v(arguments[0]),t,n,arguments);var e={};e[u.CREATED]="",x.forQualifyingSlotNamesCallAdapters(D(e),arguments,!1)}:(y.log("display: originalFunction is not a function"),null)},m.newAddHookOnGoogletagDisplay=function(e){x.displayHookIsAdded||(x.displayHookIsAdded=!0,y.addHookOnFunction(e,!1,"display",this.newDisplayFunction))},m.findWinningBidIfRequired_Refresh=function(e,t,n){return y.isOwnProperty(x.slotsMap,e)&&!0===x.slotsMap[e].isRefreshFunctionCalled()&&x.slotsMap[e].getStatus()!==u.DISPLAYED?(x.findWinningBidAndApplyTargeting(t),x.updateStatusAfterRendering(t,!0),!0):n},m.postTimeoutRefreshExecution=function(e,t,n,i){var o=!1;y.forEachOnArray(e,function(e,t){var n=x.slotsMap[t].getDivID();o=x.findWinningBidIfRequired_Refresh(t,n,o)}),this.callOriginalRefeshFunction(o,t,n,i)},m.callOriginalRefeshFunction=function(e,t,n,i){!0===e?(k("refresh",i,t),n.apply(t,i)):k("refresh",i,t)},m.getQualifyingSlotNamesForRefresh=A,m.newRefreshFuncton=function(i,o){return y.isObject(i)&&y.isFunction(o)?a()?function(){return o.apply(i,arguments)}:function(){Q("refresh",arguments),x.updateSlotsMapFromGoogleSlots(i.getSlots(),arguments,!1);var e=A(arguments,i),t=x.forQualifyingSlotNamesCallAdapters(e,arguments,!0),n=arguments;t?x.executeDisplay(s(),null,e,function(){x.postTimeoutRefreshExecution(e,i,o,n)}):x.postTimeoutRefreshExecution(e,i,o,n)}:null},m.addHooks=function(e){var t;return!!(y.isObject(e)&&y.isObject(e.googletag)&&y.isFunction(e.googletag.pubads))&&(t=(e=e.googletag).pubads(),!!y.isObject(t))&&(y.addHookOnFunction(t,!1,"disableInitialLoad",x.newDisableInitialLoadFunction),y.addHookOnFunction(t,!1,"enableSingleRequest",x.newEnableSingleRequestFunction),x.newAddHookOnGoogletagDisplay(e),y.addHookOnFunction(t,!1,"refresh",x.newRefreshFuncton),y.addHookOnFunction(e,!1,"destroySlots",x.newDestroySlotsFunction),!0)},m.defineGPTVariables=function(e){return!!y.isObject(e)&&(e.googletag=e.googletag||{},e.googletag.cmd=e.googletag.cmd||[],!0)},m.addHooksIfPossible=function(e){var t;return y.isObject(e.googletag)&&!e.googletag.apiReady&&y.isArray(e.googletag.cmd)&&y.isFunction(e.googletag.cmd.unshift)?(t=this,e.googletag.cmd.unshift(function(){t.addHooks(e)}),console.log("JXDBG_jxonescript yes hook"),fetch("https://traid.jixie.io/sync/oshk1?osEId="+n,{method:"get",mode:"no-cors"}).catch(e=>{}),!0):(fetch("https://traid.jixie.io/sync/oshk0?osEId="+n,{method:"get",mode:"no-cors"}).catch(e=>{}),console.log("JXDBG_jxonescript no hook"),o.oldintegration&&(i=!1),!1)};const q=3;var O=o.adUnits;try{if(-1<window.location.search.indexOf("jxosovr=")){var w=new URL(document.location.toString()).searchParams.get("jxosovr");if(w){var E=w.split("|");if(2==E.length){var z=E[0];let t=E[1];var L=O.find(e=>e.code==t);L&&(O=[{code:t,mediaTypes:L.mediaTypes,bids:[{bidder:"jixie",params:{unit:z}}]}])}}}}catch(e){console.log(e)}var m=null,T=0,H=!1,F=(window.jxAUOverride&&(O.length=0,O=window.jxAUOverride),O.map(e=>e.code));function G(){var e,t;H||(H=!0,e=o.pbjsCfg,-1<o.uids.indexOf("tdid")&&(t=function(e){for(var t=e+"=",n=decodeURIComponent(document.cookie).split(";"),i=0;i<n.length;i++){for(var o=n[i];" "==o.charAt(0);)o=o.substring(1);if(0==o.indexOf(t))return o.substring(t.length,o.length)}return""}("_jxtdid"))&&e.userSync.userIds.push({name:"unifiedId",value:{tdid:t}}),-1<o.uids.indexOf("tdid2")&&e.userSync.userIds.push({name:"uid2"}),jxpbjs.setConfig(e),jxpbjs.bidderSettings={standard:{storageAllowed:!0},jixie:{storageAllowed:!0},teads:{storageAllowed:!0}},jxpbjs.addAdUnits(O))}var N=100;function J(e){return{id:++N,open:!0,start:Date.now(),divs:[],type:e}}function W(t,e){t.triggered=!0;var n=Date.now();t.divs.forEach(function(e){delete d[e]});let i=F.filter(e=>-1<t.divs.indexOf(e));if(!i.length)return U("noslot",t),!1;if(t.adUnitCodes=i,!(T>q)){lastTrigger=n;let e=V.bind({BB:t,bidsBack:!0});return jxpbjs.que.push(function(){G(),T++,U("default",t),jxpbjs.requestBids({adUnitCodes:i,bidsBackHandler:e,timeout:o.PREBID_TIMEOUT})}),!0}n=V.bind({BB:t}),setTimeout(n,0),U("throttled",t)}function V(){let o=this.bidsBack,s=(!0===o&&T--,this.BB);s&&!s.handled&&(s.handled=!0,googletag.cmd.push(function(){if("auto"==s.type){var e=[];if(o){jxpbjs.setTargetingForGPTAsync();for(var t=googletag.pubads().getSlots(),n=0;n<t.length;n++)0<t[n].getTargeting("hb_bidder").length&&e.push(t[n]);e.length&&googletag.pubads().refresh(e)}X(o?"bidsback":"timeout",s,e.length?["got(no details)"]:[])}else{var i=googletag.pubads().getSlots();let n=[];i.forEach(function(e){var t,e=e.getSlotElementId();-1<s.divs.indexOf(e)&&o&&-1<s.adUnitCodes.indexOf(e)&&((t=jxpbjs.getAdserverTargetingForAdUnitCode(e)).hb_bidder?(n.push(e+t.hb_bidder),d[e]=t):d[e]=r)}),X(o?"bidsback":"timeout",s,n)}}))}y.isObject(w=e)&&(x.defineGPTVariables(w),x.addHooksIfPossible(w)),i||((m=J("auto")).divs=F,E=W.bind(null,m,!0),setTimeout(E,0)),window.jxAUOverride||setTimeout(function(){var e=document.createElement("div"),t=(e.style.display="none",document.createElement("iframe"));t.height="1",t.frameborder="0",t.src="https://scripts.jixie.media/jx-load-cookie.html?accountid=${accountId}",e.appendChild(t),document.body.append(t)},5e3);var _={displayTotal:0,refreshTotal:0,displayOpen:0,refreshOpen:0,displayArr:{},refreshArr:{}},R=[],C=!0;function U(e,t){C||R.push({id:t.id,time:Date.now(),type:e,divs:t.divs.join(","),slots:t.adUnitCodes?t.adUnitCodes.join(","):"none",allUnitCodes:F.join(","),outcomes:[]})}function X(e,t,n){var i;C||((i=R.find(e=>e.id==t.id))?i.outcomes.push({time:Date.now(),type:e,bids:n}):R.push({time:Date.now(),type:e,slots:t.adUnitCodes?t.adUnitCodes.join(","):"none",bids:n}))}function K(e){try{return e[0]}catch(e){return"noDivInfo"}}function Q(e,t,n){if(!C)if("display"==e)try{_.displayTotal++,_.displayOpen++;var i=K(t);_.displayArr[i]||(_.displayArr[i]=[]),_.displayArr[i].push("outer"+Date.now())}catch(e){console.log(e)}else if("refresh"==e)try{_.refreshTotal++,_.refreshOpen++;var o=I(n,t);_.refreshArr[o]||(_.refreshArr[o]=[]),_.refreshArr[o].push("outer"+Date.now())}catch(e){console.log(e)}}function k(e,t,n){if(!C)if("display"==e)try{_.displayOpen--;var i=K(t);_.displayArr[i]||(_.displayArr[i]=[]),_.displayArr[i].push("inner"+Date.now())}catch(e){console.log(e)}else if("refresh"==e)try{_.refreshOpen--;var o=I(n,t);_.refreshArr[o]||(_.refreshArr[o]=[]),_.refreshArr[o].push("inner"+Date.now())}catch(e){console.log(e)}}function Y(e){try{_slackBlob={text:"x",blocks:[{type:"section",text:{type:"mrkdwn",text:JSON.stringify(e,null,2)+"\n"+JSON.stringify(R,null,2)}}]};var t=JSON.stringify(_slackBlob),n=new XMLHttpRequest;n.open("POST","https://hooks.slack.com/services/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?text=xxxxxyyyyyzzzzz"),n.send(t)}catch(e){}}C||setTimeout(function(){console.log("<---------C:-----------------------"),console.log(JSON.stringify(_,null,2)),console.log(JSON.stringify(R,null,2)),console.log("---------C:-----------------------\x3e"),Y(_),Y(R)},25e3)}("Si23559958R6M",jxloadJS,{pbjs:null,adUnits:[{code:"div-gpt-ad-billboard",mediaTypes:{banner:{sizes:[[728,90],[970,250]]}},bids:[{bidder:"jixie",params:{unit:"1000599-ugsnTBdFVL"}},{bidder:"yandex",params:{cur:"USD",impId:11,pageId:9146523}}]},{code:"div-gpt-ad-topcenter",mediaTypes:{banner:{sizes:[[320,50],[320,100]]}},bids:[{bidder:"jixie",params:{unit:"1000599-cvE8DTPMnI"}},{bidder:"yandex",params:{cur:"USD",impId:2,pageId:9146523}}]},{code:"div-gpt-ad-center2",mediaTypes:{banner:{sizes:[[300,250]]}},bids:[{bidder:"jixie",params:{unit:"1000599-aotar3wdmN"}},{bidder:"yandex",params:{cur:"USD",impId:4,pageId:9146523}}]},{code:"div-gpt-ad-giantrec",mediaTypes:{banner:{sizes:[[300,250],[300,600]]}},bids:[{bidder:"jixie",params:{unit:"1000599-CJ12xrLaEy"}},{bidder:"yandex",params:{cur:"USD",impId:13,pageId:9146523}}]},{code:"div-gpt-ad-megabillboard",mediaTypes:{banner:{sizes:[[320,480],[300,600],[300,250]]}},bids:[{bidder:"jixie",params:{unit:"1000599-BkAlbagmdw"}},{bidder:"yandex",params:{cur:"USD",impId:9,pageId:9146523}}]},{code:"div-gpt-ad-bottomrec",mediaTypes:{banner:{sizes:[[300,250],[300,600]]}},bids:[{bidder:"jixie",params:{unit:"1000599-8FiGDdfc70"}},{bidder:"yandex",params:{cur:"USD",impId:14,pageId:9146523}}]},{code:"div-gpt-ad-horizonad",mediaTypes:{banner:{sizes:[[728,90]]}},bids:[{bidder:"jixie",params:{unit:"1000599-P9Duk4ATqI"}},{bidder:"yandex",params:{cur:"USD",impId:17,pageId:9146523}}]},{code:"div-gpt-ad-center1",mediaTypes:{banner:{sizes:[[300,250]]}},bids:[{bidder:"jixie",params:{unit:"1000599-UoKGUrvPqy"}},{bidder:"yandex",params:{cur:"USD",impId:3,pageId:9146523}}]},{code:"div-gpt-ad-pixel",mediaTypes:{banner:{sizes:[[1,1]]}},bids:[{bidder:"jixie",params:{unit:"1000599-42C85ulxJU"}},{bidder:"yandex",params:{cur:"USD",impId:6,pageId:9146523}}]},{code:"div-gpt-ad-stickyad",mediaTypes:{banner:{sizes:[[320,100]]}},bids:[{bidder:"jixie",params:{unit:"1000599-upgb4S1909"}},{bidder:"yandex",params:{cur:"USD",impId:5,pageId:9146523}}]},{code:"div-gpt-ad-leaderboard",mediaTypes:{banner:{sizes:[[728,90]]}},bids:[{bidder:"jixie",params:{unit:"1000599-ZDG5nLB3H4"}},{bidder:"yandex",params:{cur:"USD",impId:10,pageId:9146523}}]},{code:"div-gpt-ad-skinad-right",mediaTypes:{banner:{sizes:[[120,600],[160,600]]}},bids:[{bidder:"jixie",params:{unit:"1000599-yycnqHtCwQ"}},{bidder:"yandex",params:{cur:"USD",impId:16,pageId:9146523}}]},{code:"div-gpt-ad-skinad-left",mediaTypes:{banner:{sizes:[[120,600],[160,600]]}},bids:[{bidder:"jixie",params:{unit:"1000599-GW8rRuolHg"}},{bidder:"yandex",params:{cur:"USD",impId:15,pageId:9146523}}]},{code:"div-gpt-ad-rectangle1",mediaTypes:{banner:{sizes:[[300,250]]}},bids:[{bidder:"jixie",params:{unit:"1000599-wSEOHAB7Se"}},{bidder:"yandex",params:{cur:"USD",impId:12,pageId:9146523}}]}],pbjsCfg:{gptPreAuction:{enabled:!0,useDefaultPreAuction:!0},enableSendAllBids:!1,priceGranularity:{buckets:[{max:2e4,min:0,increment:200,precision:2},{max:158e3,min:2e4,increment:2e3,precision:2},{max:31e4,min:158e3,increment:8e3,precision:2}]},userSync:{userIds:[]},jixie:{genids:[{id:"_jxtoko"},{id:"esha",ck:"sindomail"}]},enableTIDs:!0,currency:{rates:{USD:{IDR:15843.198243527584},EUR:{IDR:17318.2}},adServerCurrency:"IDR"},useBidCache:!1},uids:["tdid",{name:"uid2"}],FAILSAFE_TIMEOUT:2e3,PREBID_TIMEOUT:1e3}),window.hasOwnProperty("jixie_o")||(window.jixie_o={logbids:!0,ad_blocker:!1,userprofile:!1,external_ids:["tdid","jxtoko","tdid2"],sha256mail_cookie:"sindomail",accountid:"Si599jSdZ1"},window.jixie_o.pbjs_name="jxpbjs",jxloadJS("https://scripts.jixie.media/jxpublisher_3_1.nb.min.js",null,document.head));