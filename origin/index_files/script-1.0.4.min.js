...
/* script.js */
$(document).ready(function (){new WOW().init(); $(".more-menu img, .more-menu-ipad img").on("click", function (e){if ($(".nav-more").hasClass("show-menu")){$(".nav-more").removeClass("show-menu");}else{$(".nav-more").addClass("show-menu");}if ($(".btn-expand").hasClass("flip-icon")){$(".btn-expand").removeClass("flip-icon");}else{$(".btn-expand").addClass("flip-icon");}}); $(".more-menu-float img, .more-menu-sticky img").on("click", function (e){if ($(".nav-more-float").hasClass("show-menu")){$(".nav-more-float").removeClass("show-menu");}else{$(".nav-more-float").addClass("show-menu");}if ($(".btn-expand-float").hasClass("flip-icon")){$(".btn-expand-float").removeClass("flip-icon");}else{$(".btn-expand-float").addClass("flip-icon");}}); $('#OpenNav').on('click', function(e){$("#nav-side").css("right","0px"); $("#nav-side").css("visibility","visible"); $("#CloseNav").css("display","inline-block"); $("#OpenNav").css("display","none");}); $('#OpenNavFloat').on('click', function(e){$("#nav-side").css("right","0px"); $("#nav-side").css("visibility","visible"); $("#CloseNavFloat").css("display","inline-block"); $("#OpenNavFloat").css("display","none");}); $('#OpenNavFloat2').on('click', function(e){$("#nav-side").css("right","0px"); $("#nav-side").css("visibility","visible"); $("#CloseNavFloat2").css("display","inline-block"); $("#OpenNavFloat2").css("display","none");}); $('#CloseNav').on('click', function(e){$("#nav-side").css("right","-600px"); $("#nav-side").css("visibility","hidden"); $("#CloseNav").css("display","none"); $("#OpenNav").css("display","inline-block");}); $('#CloseNavFloat').on('click', function(e){$("#nav-side").css("right","-600px"); $("#nav-side").css("visibility","hidden"); $("#CloseNavFloat").css("display","none"); $("#OpenNavFloat").css("display","inline-block");}); $('#CloseNavFloat2').on('click', function(e){$("#nav-side").css("right","-600px"); $("#nav-side").css("visibility","hidden"); $("#CloseNavFloat2").css("display","none"); $("#OpenNavFloat2").css("display","inline-block");}); $(document).mouseup(function(e){var NavSide=$('.menu'); if (!NavSide.is(e.target) && NavSide.has(e.target).length===0){$("#nav-side").css("right","-600px"); $("#nav-side").css("visibility","hidden"); $("#CloseNavFloat").css("display","none"); $("#CloseNavFloat2").css("display","none"); $("#CloseNav").css("display","none"); $("#OpenNavFloat").css("display","inline-block"); $("#OpenNavFloat2").css("display","inline-block"); $("#OpenNav").css("display","inline-block");}});});$(window).scroll(function(){if (document.body.scrollTop > 130 || document.documentElement.scrollTop > 130){$("#sticky-header").css("top","0px"); $("#sticky-header-mobile").css("top","0px"); $("#nav-side").css("paddingTop","50px");}else{$("#sticky-header").css("top","-300px"); $("#sticky-header-mobile").css("top","-300px"); $("#nav-side").css("paddingTop","126px");}});var SwiperTopic=new Swiper(".SwiperTopic",{slidesPerView: "auto", navigation:{nextEl: ".SwiperTopic-next", prevEl: ".SwiperTopic-prev"}});var SwiperNavHead=new Swiper(".SwiperNavHead",{slidesPerView: "auto", navigation:{nextEl: ".swiper-button-next-NavHead", prevEl: ".swiper-button-prev-NavHead"}});var SwiperNavHeadFloat=new Swiper(".SwiperNavHeadFloat",{slidesPerView: "auto", navigation:{nextEl: ".swiper-button-next-NavHeadFloat", prevEl: ".swiper-button-prev-NavHeadFloat"}});var SwiperHilite=new Swiper(".SwiperHilite",{slidesPerView: "auto", spaceBetween: 24, loop: false, navigation:{nextEl: ".SwiperHilite-next", prevEl: ".SwiperHilite-prev"}});var SwiperVideo=new Swiper(".SwiperVideo",{slidesPerView: "auto", spaceBetween: 24, loop: false, navigation:{nextEl: ".SwiperVideo-next", prevEl: ".SwiperVideo-prev"}});var SwiperInfografis=new Swiper(".SwiperInfografis",{slidesPerView: "auto", centeredSlides: true, loop: true, navigation:{nextEl: ".swiper-button-next-infografis", prevEl: ".swiper-button-prev-infografis"}});var SwiperScope=new Swiper(".SwiperScope",{slidesPerView: "auto", centeredSlides: true, loop: true, navigation:{nextEl: ".swiper-button-next-scope", prevEl: ".swiper-button-prev-scope"}});var SwiperNewsMpi=new Swiper(".SwiperNewsMpi",{slidesPerView: "auto", spaceBetween: 24, loop: true, navigation:{nextEl: ".swiper-button-next-qatar", prevEl: ".swiper-button-prev-qatar"}});$(".control-nav-right .swiper-button-next-NavHeadFloat").hover(function (){$(this).trigger("click");});$(".control-nav-left .swiper-button-prev-NavHeadFloat").hover(function (){$(this).trigger("click");});btnTop=document.getElementById("Btn2Top");$.fn.scrollEnd=function (callback, timeout){$(this).scroll(function (){var $this=$(this); if ($this.data("scrollTimeout")){btnTop.style.opacity="0.2"; clearTimeout($this.data("scrollTimeout"));}$this.data("scrollTimeout", setTimeout(callback, timeout));});};$(window).scrollEnd(function (){btnTop.style.opacity="1";});window.onscroll=function (){scrollTop();};function scrollTop(){if (document.body.scrollTop > 130 || document.documentElement.scrollTop > 130){$("#Btn2Top").css("display", "block");}else{$("#Btn2Top").css("display", "none");}}function topFunction(){$("html, body").animate({scrollTop: 0}, 500);}$("#comment").click(function (){$("html, body").animate({scrollTop: $("#komentar").offset().top - 40}, 500);});function copyLink(){var copyText=document.getElementById("urlLink"); navigator.clipboard.writeText(copyText.value); alert("Link Copied");}